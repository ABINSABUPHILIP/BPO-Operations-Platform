      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _options$language = options.language, language = _options$language === void 0 ? 'eng' : _options$language, errorHandler = options.errorHandler;
            _context.next = 7;
            return src.createWorker();
          case 7:
            worker = _context.sent;
            _context.prev = 8;
            _context.next = 11;
            return worker.loadLanguage(language);
          case 11:
            _context.next = 13;
            return worker.initialize(language);
          case 13:
            _context.next = 15;
            return worker.recognize(image, _objectSpread2({}, options));
          case 15:
